...
export function ValidateFetchedDog(dog: ILostDogWithPicture | ILostDog) {
  ...
  dog.breed = Object.values(BreedTypes).includes(dog.breed as BreedTypes) ? dog.breed : "";
  ...
  dog.size = Object.values(SizeTypes).includes(dog.size as SizeTypes) ? dog.size : "";
  ...
  dog.hairLength = Object.values(HairTypes).includes(dog.hairLength as HairTypes)
    ? dog.hairLength
    : "";
  dog.size = ValidateSelectedFeatures(dog.size);
  dog.size = Object.values(SizeTypes).includes(dog.size as SizeTypes) ? dog.size : "";
  ...
  dog.tailLength = Object.values(TailTypes).includes(dog.tailLength as TailTypes)
    ? dog.tailLength
    : "";
  return dog;
}
