...
export default function ReviewAndPost() {
  ...
  function handleLocationChange({ name, value }: any) {
    let newDetails = {
      ...details,
      location: { ...details.location, [name as string]: value },
  ...
  function areValidDetails(ch: IDogDetails) {
    return (
      ch.location.city !== initDogDetails.location.city &&
      ch.location.district != initDogDetails.location.district
    );
  }
    ...
    <View style={{ padding: 7, backgroundColor: "#ffffff", borderRadius: 5 }}>
        ...
        <View style={{ flex: 6 }}>
          <View style={{ marginRight: "5%" }}>
            ...
            <View style={[styles.row]}>
              ...
              <View style={{ flex: 1 }}>
                <TextField
                  value={convertDate(date.toISOString())}
                  placeholder="Lost on"
                />
              </View>
          ...
          <TextInput
            editable
            defaultValue={details.location.city}
            placeholder="City"
            style={styles.input}
            onChangeText={(value) =>
              handleLocationChange({ name: "city", value: value })
            }
          ></TextInput>
          <View
            style={{
          ...
          <View style={{ paddingTop: 12 }}>
            ...
            <TextInput
              editable
              defaultValue={details.location.district}
              placeholder="District"
              style={styles.input}
              onChangeText={(value) =>
                handleLocationChange({ name: "district", value: value })
              }
            ></TextInput>
            <View
              style={{
      ...
      >
        <KeyboardAvoidingView>
          ...
          <TextField
            value={dogCharacteristics.specialMark}
