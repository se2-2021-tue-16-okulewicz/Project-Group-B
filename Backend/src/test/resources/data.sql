...
insert into lost_dog (id, age, breed, color, ears_type, hair_length, name, size, special_marks, tail_length, date_lost, city, owner_id, is_is_found, district, picture_id) values (10001, 12, 'unknown', 'blue', 'long', 'long', 'Pinky', 'big', 'none', 'long', null, 'Lublin', 10001, 0, 'Bronowice', 10001);
insert into lost_dog (id, age, breed, color, ears_type, hair_length, name, size, special_marks, tail_length, date_lost, city, owner_id, is_is_found, district, picture_id) values (10002, 13, 'random', 'brown', 'long', 'short', 'Borys', 'big', 'none', 'short', null, 'Lublin', 10001, 1, 'Bronowice', 10002);
insert into lost_dog (id, age, breed, color, ears_type, hair_length, name, size, special_marks, tail_length, date_lost, city, owner_id, is_is_found, district, picture_id) values (10003, 14, 'bulldog', 'blonde', 'long', 'short', 'Warus', 'small', 'gray ears', 'long', null, 'Lublin', 10002, 0, 'LSM', 10003);
insert into lost_dog (id, age, breed, color, ears_type, hair_length, name, size, special_marks, tail_length, date_lost, city, owner_id, is_is_found, district, picture_id) values (10004, 15, 'unknown', 'pink', 'short', 'long', 'Pimpek', 'small', 'none', 'long', null, 'Warsaw', 10003, 1, 'Ursynów', 10004);
